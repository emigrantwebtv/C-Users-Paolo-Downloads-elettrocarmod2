...
export default function PhotoSlideshow({ className = "" }: PhotoSlideshowProps) {
  ...
  if (isLoading) {
    return (
      <div className={`bg-gray-200 animate-pulse rounded-t-lg h-auto ${className}`}>
  ...
  if (shuffledPhotos.length === 0) {
    return (
      <div className={`bg-gray-100 rounded-t-lg flex items-center justify-center h-auto ${className}`}>
