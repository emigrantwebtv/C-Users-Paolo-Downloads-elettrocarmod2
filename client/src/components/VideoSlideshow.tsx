    ...
    <div className={`relative ${className}`}>
      <div className="bg-gray-100 rounded-t-lg overflow-hidden">
        {displayVideos.length === 0 ? (
          <div className="aspect-video max-h-[60vh] bg-gray-200 flex items-center justify-center">
          ...
          <div className="aspect-video max-h-[60vh] bg-black flex items-center justify-center relative">
            <video
